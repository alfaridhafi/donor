    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              <div class="dropdown-header">Pesan
                <div class="float-right">
                  <a href="#">Pesan yang belum terbaca</a>
                </div>
              </div>
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Orang Layo</b>
                    <p>Saya Sedang Mencari Golongan Darah O</p>
          ...
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              <div class="dropdown-header">Notifikasi
                <div class="float-right">
                  <a href="#">Notifikasi Yang Belum Terbaca</a>
                </div>
              </div>
              <div class="dropdown-list-content dropdown-list-icons">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  ...
                  <div class="dropdown-item-desc">
                    Terdapat 8 orang yang bersedia mendonorkan darah
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user ">
              <img alt="image" src="/img/Logo2.png" class="rounded-circle mr-1">
              <div class="d-sm-none d-lg-inline-block ms-right">Unsri Peduli</div>
            </a>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Unsri Peduli</a>
          </div>
          ...
          <ul class="sidebar-menu">
            <!-- <li class="menu-header">Dahboard</li>
              <li class="nav-item dropdown">
                <a href="/pages/home" class="nav-link "><i class="fas fa-fire"></i><span>Home</span></a> -->
            <!-- <ul class="dropdown-menu">
                  <li><a class="nav-link" href="/pages/home">Halaman Utama</a></li>
            ...
            <li class="active"><a class="nav-link" href="#"><i class=""></i> <span>Data Calon Pendonor</span></a></li>
            <!-- <li class="nav-item dropdown">
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <div class="card">
              <h5 class="card-header">Calon Pendonor</h5>
                ...
                <div class="table-responsive">
                  <table class="table table-hover table-borderless ">
                    ...
                    <tbody>
                      ...
                      <?php foreach ($pendonor as $c) : ?>
                        <tr>
                          <th scope="row"><?= $i++; ?></th>
                          <td><?= $c['nama_pendonor']; ?></td>
                          <td><?= $c['alamat']; ?></td>
                          <td><?= $c['golongan_darah']; ?></td>
                          <td><?= $c['berat_badan']; ?></td>
                          <td><?= $c['usia']; ?></td>
                          <td><?= $c['jenis_kelamin']; ?></td>
                          <td><?= $c['terakhir_donor']; ?></td>
                          <td><?= $c['nomor_telepon']; ?></td>
                          <td><a class="btn btn-success" href="Admin/edit/<?= $c['slug']; ?>" role="button">ubah</a></td>
                        </tr>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2021 <div class="bullet"></div> UnsriPeduli
